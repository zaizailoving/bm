...
namespace BM.Service.Core.Controller
{
    ...
    public class AccountController : BaseController
    {
        ...
        public async Task<ResultModel<string>> RefreshToken([FromBody] RefreshTokenInPutViewModel inPutViewModel)
        {
            ...
            var cachedRefreshToken = _cacheManager.Get<string>($"BM.Service_WebRefreshToken_{currentUser.user_id}");
            if (!flag || !string.Equals(cachedRefreshToken, inPutViewModel.RefreshToken, StringComparison.Ordinal))
            {
